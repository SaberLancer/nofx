  ...
  const handleSaveEditTrader = async (data: CreateTraderRequest) => {
    ...
    try {
      ...
      const request = {
        ...
        regime_switch_enabled: data.regime_switch_enabled,
        trend_strategy_id: data.trend_strategy_id,
        oscillation_strategy_id: data.oscillation_strategy_id,
        regime_confirm_cycles: data.regime_confirm_cycles,
        regime_detection: data.regime_detection,
