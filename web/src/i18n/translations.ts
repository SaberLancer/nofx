...
const translationsBase = {
  en: {
    ...
    success: 'Success',
    failed: 'Failed',
    preDecisionSkipped: 'Pre-Decision Skipped',
    preDecisionSkippedHint: 'No directional tick trend; AI analysis was skipped this cycle',
    decisionCard: {
      snapshotHint: 'Snapshot at decision time; live P&L may differ',
      timezoneHint: 'All times shown in Beijing Time (UTC+8)',
      pnlLagTitle: 'Decision vs live P&L drift',
      pnlAtDecision: 'At decision {pct}',
      pnlLiveNow: 'Now {pct}',
      candidateUnavailable: 'UNAVAILABLE',
      candidateUnavailableDefault: 'Market data unavailable or no AI decision for this candidate',
      actionOpenLong: 'LONG',
      actionOpenShort: 'SHORT',
      actionCloseLong: 'CLOSE LONG',
      actionCloseShort: 'CLOSE SHORT',
      actionClose: 'CLOSE',
      actionHold: 'HOLD',
      actionWait: 'WAIT',
      viewChartTitle: 'Click to view chart',
    ...
    configActiveUsage: '{running}/{total} active',
    configStandby: 'Standby',
    configExchangeUnavailable: 'Unavailable',
    ...
    positionHistory: {
      ...
      timeFrom: 'From',
      timeTo: 'To',
      noFilterResults: 'No positions match the current filters.',
      ...
      viewCloseDetail: 'Close detail',
      closeDetailTitle: 'Position Details',
      closeDetailSummary: 'Initial qty {initial}, reduced {reduced} ({pct}%)',
      loadingCloseDetail: 'Loading reduce/close details...',
      noCloseDetail: 'No reduce/close records found in this window.',
      closeDetailFetchFailed: 'Failed to load reduce/close details.',
      closeDetailPrice: 'Avg. Price',
      closeDetailQty: 'Filled Qty',
      closeDetailAction: 'Action',
      closeDetailFee: 'Fee',
      closeDetailPnl: 'PnL',
      closeDetailRoi: 'Close ROI',
      closeDetailStatus: 'Status',
    },
    ...
    advancedChart: {
      ...
      adxPeriod: 'Period',
      adxKlineCount: 'Bars',
      adxRegime1h: '1H·regime',
      adxChartOnly: 'chart TF',
      shares: 'shares',
      units: 'units',
    },
    ...
    traderDashboard: {
      ...
      uPnL: 'uPnL',
      marginPnlPct: 'PnL%',
      marginPnlPctHint: 'Margin PnL% (unrealized return on margin, leverage included — same as AI decision context)',
      liq: 'Liq.',
      ...
      runtimeMin: 'min',
      debugOnline: 'SYSTEM_STATUS::ONLINE',
      debugLastUpdate: 'LAST_UPDATE',
      debugEq: 'EQ',
      debugPnl: 'PNL',
      positionsUnitActive: 'ACTIVE',
    },

    aiTradersHeader: {
      activeNodes: '{count} active',
      systemReady: 'System ready',
      modelsConfig: 'Configure models',
      exchangeKeys: 'Configure exchange',
    ...
    settingsPage: {
      ...
      modelsConfigured: '{count} model configured',
      modelsConfiguredPlural: '{count} models configured',
      addModel: 'Add Model',
      noModelsYet: 'No AI models configured yet',
      exchangesConnected: '{count} account connected',
      exchangesConnectedPlural: '{count} accounts connected',
      addExchange: 'Add Exchange',
      noExchangesYet: 'No exchange accounts connected yet',
      telegramDesc: 'Connect a Telegram bot to receive trading notifications and interact with your traders.',
      configureTelegram: 'Configure Telegram Bot',
      badgeApiKey: 'API Key',
      badgeVariant: 'Variant',
      badgeBaseUrl: 'Base URL',
      badgeSecret: 'Secret',
      badgePassphrase: 'Passphrase',
      badgeWallet: 'Wallet',
      badgeAsterKey: 'Aster Key',
      badgeLighterKey: 'Lighter Key',
      statusActive: 'Active',
      statusInactive: 'Inactive',
      loadModelsFailed: 'Failed to load AI models',
      loadExchangesFailed: 'Failed to load exchanges',
      deleteExchangeFailed: 'Failed to delete exchange account',
    },
  ...
  zh: {
    ...
    decisionCard: {
      snapshotHint: '决策时刻快照，当前盈亏可能已变化',
      timezoneHint: '所有时间均为北京时间 (UTC+8)',
      pnlLagTitle: '决策时 vs 当前盈利率偏差',
      pnlAtDecision: '决策时 {pct}',
      pnlLiveNow: '当前 {pct}',
      candidateUnavailable: '不可用',
      candidateUnavailableDefault: '行情数据不可用，或 AI 未对该候选币输出决策',
      actionOpenLong: '开多',
      actionOpenShort: '开空',
      actionCloseLong: '平多',
      actionCloseShort: '平空',
    ...
    configActiveUsage: '{running}/{total} 运行中',
    configStandby: '就绪',
    configExchangeUnavailable: '暂时无法获取',
    ...
    positionHistory: {
      ...
      viewCloseDetail: '平/减仓详情',
      closeDetailTitle: '仓位详情',
      closeDetailSummary: '初始仓位 {initial}，累计减仓 {reduced}（{pct}%）',
      loadingCloseDetail: '加载减仓/平仓明细...',
      noCloseDetail: '该时段未查到减仓/平仓明细',
      closeDetailFetchFailed: '加载减仓/平仓明细失败',
      closeDetailPrice: '成交均价',
      closeDetailQty: '成交量',
      closeDetailAction: '动作',
      closeDetailFee: '手续费',
      closeDetailPnl: '盈亏',
      closeDetailRoi: '平仓收益率',
      closeDetailStatus: '状态',
    },
    ...
    strategyStudio: {
      ...
      customPromptDesc: '附加在系统提示词末尾的额外说明，用于补充个性化交易风格',
      customPromptPlaceholder: '输入自定义提示词...',
      generatePromptPreview: '点击生成提示词预览',
    ...
    traderDashboard: {
      ...
      uPnL: '未实现盈亏',
      marginPnlPct: '收益率',
      marginPnlPctHint: '相对保证金的收益率（含杠杆，与 AI 决策上下文一致）',
      liq: '强平价',
      closePosition: '平仓',
      close: '平仓',
      ...
      runtimeMin: '分钟',
      debugOnline: '系统状态::在线',
      debugLastUpdate: '最近更新',
      debugEq: '净值',
      debugPnl: '盈亏',
      positionsUnitActive: '活跃',
    },

    aiTradersHeader: {
      activeNodes: '{count} 个运行中',
      systemReady: '系统就绪',
      modelsConfig: '配置模型',
      exchangeKeys: '配置交易所',
    ...
    settingsPage: {
      ...
      modelsConfiguredPlural: '已配置 {count} 个模型',
      addModel: '添加模型',
      noModelsYet: '尚未配置 AI 模型',
      exchangesConnected: '已连接 {count} 个账户',
      exchangesConnectedPlural: '已连接 {count} 个账户',
      addExchange: '添加交易所',
      noExchangesYet: '尚未连接交易所账户',
      telegramDesc: '连接 Telegram 机器人以接收交易通知，并与交易员交互。',
      configureTelegram: '配置 Telegram 机器人',
      badgeApiKey: 'API Key',
      badgeVariant: '模型版本',
      badgeBaseUrl: '接口地址',
      badgeSecret: 'Secret',
      badgePassphrase: 'Passphrase',
      badgeWallet: '钱包',
      badgeAsterKey: 'Aster 密钥',
      badgeLighterKey: 'Lighter 密钥',
      statusActive: '已启用',
      statusInactive: '未启用',
      loadModelsFailed: '加载 AI 模型失败',
      loadExchangesFailed: '加载交易所失败',
      deleteExchangeFailed: '删除交易所账户失败',
    },
  ...
  id: {
    ...
    success: 'Berhasil',
    failed: 'Gagal',
    preDecisionSkipped: 'Pre-Decision Dilewati',
    preDecisionSkippedHint: 'Tidak ada sinyal arah tick; analisis AI dilewati pada siklus ini',
    decisionCard: {
      snapshotHint: 'Snapshot saat keputusan; P&L live mungkin berbeda',
      pnlLagTitle: 'Selisih P&L keputusan vs live',
      pnlAtDecision: 'Saat keputusan {pct}',
      pnlLiveNow: 'Sekarang {pct}',
      candidateUnavailable: 'TIDAK TERSEDIA',
      candidateUnavailableDefault: 'Data pasar tidak tersedia atau AI tidak mengeluarkan keputusan untuk kandidat ini',
      actionOpenLong: 'LONG',
      actionOpenShort: 'SHORT',
      actionCloseLong: 'TUTUP LONG',
      actionCloseShort: 'TUTUP SHORT',
      actionClose: 'TUTUP',
      actionHold: 'TAHAN',
      actionWait: 'TUNGGU',
      viewChartTitle: 'Klik untuk lihat grafik',
    ...
    configActiveUsage: '{running}/{total} aktif',
    configStandby: 'Siaga',
    ...
    positionHistory: {
      ...
      timeFrom: 'Dari',
      timeTo: 'Sampai',
      noFilterResults: 'Tidak ada posisi yang cocok dengan filter saat ini.',
      ...
      viewOpenDecision: 'Keputusan buka',
      viewCloseDecision: 'Keputusan tutup',
      viewCloseDetail: 'Detail tutup',
      closeDetailTitle: 'Detail posisi',
      closeDetailSummary: 'Qty awal {initial}, total dikurangi {reduced} ({pct}%)',
      loadingCloseDetail: 'Memuat detail reduce/close...',
      noCloseDetail: 'Tidak ada record reduce/close di rentang ini.',
      closeDetailFetchFailed: 'Gagal memuat detail reduce/close.',
      closeDetailPrice: 'Harga rata-rata',
      closeDetailQty: 'Qty terisi',
      closeDetailAction: 'Aksi',
      closeDetailFee: 'Biaya',
      closeDetailPnl: 'PnL',
      closeDetailRoi: 'ROI Tutup',
      closeDetailStatus: 'Status',
    },
    ...
    traderDashboard: {
      ...
      uPnL: 'uPnL',
      marginPnlPct: 'PnL%',
      marginPnlPctHint: 'Margin PnL% (laba/rugi belum terealisasi terhadap margin, termasuk leverage)',
      liq: 'Liq.',
      ...
      runtimeLabel: 'Runtime',
      runtimeMin: 'mnt',
      debugOnline: 'STATUS::ONLINE',
      debugLastUpdate: 'UPDATE',
      debugEq: 'EQ',
      debugPnl: 'PNL',
      positionsUnitActive: 'AKTIF',
    },

    aiTradersHeader: {
      activeNodes: '{count} aktif',
      systemReady: 'Sistem siap',
      modelsConfig: 'Konfigurasi model',
      exchangeKeys: 'Konfigurasi bursa',
    ...
    settingsPage: {
      ...
      modelsConfigured: '{count} model dikonfigurasi',
      modelsConfiguredPlural: '{count} model dikonfigurasi',
      addModel: 'Tambah Model',
      noModelsYet: 'Belum ada model AI',
      exchangesConnected: '{count} akun terhubung',
      exchangesConnectedPlural: '{count} akun terhubung',
      addExchange: 'Tambah Bursa',
      noExchangesYet: 'Belum ada akun bursa',
      telegramDesc: 'Hubungkan bot Telegram untuk notifikasi trading.',
      configureTelegram: 'Konfigurasi Bot Telegram',
      badgeApiKey: 'API Key',
      badgeVariant: 'Varian',
      badgeBaseUrl: 'Base URL',
      badgeSecret: 'Secret',
      badgePassphrase: 'Passphrase',
      badgeWallet: 'Dompet',
      badgeAsterKey: 'Kunci Aster',
      badgeLighterKey: 'Kunci Lighter',
      statusActive: 'Aktif',
      statusInactive: 'Nonaktif',
      loadModelsFailed: 'Gagal memuat model AI',
      loadExchangesFailed: 'Gagal memuat bursa',
      deleteExchangeFailed: 'Gagal menghapus akun bursa',
    },
