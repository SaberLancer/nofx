...
const translationsBase = {
  en: {
    ...
    decisionCard: {
      snapshotHint: 'PnL% in this card is from this cycle only (not live)',
      pnlLagTitle: 'Live position PnL% has moved since this decision',
  ...
  zh: {
    ...
    decisionCard: {
      snapshotHint: '本卡片盈利率为决策当时快照，非实时持仓',
      pnlLagTitle: '当前持仓盈利率已变化（相对本周期决策）',
