...
export const promptSections = {
  ...
  reduceStandards: { zh: '减仓标准', en: 'Reduce Standards', es: 'Estándares de Reducción' },
  reduceStandardsDesc: { zh: '定义锁盈减仓与降风险规则（支持 close_ratio）', en: 'Define de-risk / profit-lock rules (supports close_ratio)', es: 'Definir reglas de reducción (close_ratio)' },
  exitStandards: { zh: '平仓标准', en: 'Exit Standards', es: 'Estándares de Salida' },
  exitStandardsDesc: { zh: '定义纪律性退出规则，防止利润回吐', en: 'Define disciplined exit rules to prevent profit giveback', es: 'Definir salida disciplinada' },
