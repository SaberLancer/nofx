...
func (s *Server) handleGetTraderConfig(c *gin.Context) {
	...
	result := map[string]interface{}{
		...
		"regime_switch_enabled":   traderConfig.RegimeSwitchEnabled,
		"trend_strategy_id":       traderConfig.TrendStrategyID,
		"oscillation_strategy_id": traderConfig.OscillationStrategyID,
		"regime_confirm_cycles":   traderConfig.RegimeConfirmCycles,
		"regime_detection":        traderConfig.RegimeDetection(),
