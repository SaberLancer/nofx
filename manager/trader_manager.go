...
func (tm *TraderManager) addTraderFromStore(traderCfg *store.Trader, aiModelCfg *store.AIModel, exchangeCfg *store.Exchange, st *store.Store) error {
	...
	traderConfig := trader.AutoTraderConfig{
		...
		RegimeSwitchEnabled:     traderCfg.RegimeSwitchEnabled,
		TrendStrategyID:         traderCfg.TrendStrategyID,
		OscillationStrategyID:   traderCfg.OscillationStrategyID,
		RegimeConfirmCycles:     traderCfg.RegimeConfirmCycles,
		RegimeDetection:         traderCfg.RegimeDetection(),
	}
